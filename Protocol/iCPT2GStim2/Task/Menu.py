...
class ConfigureScreen(MenuBase):
    def __init__(self, **kwargs):
        ...
        for option in self.stim_duration_probe_list:
            ...
            stim_duration_opt.bind(
                on_release=lambda stim_duration_opt: self.stim_duration_probe_dropdown.select(stim_duration_opt.text))
        ...
        self.stim_duration_probe_dropdown.bind(
            on_select=lambda instance, x: setattr(self.stim_duration_probe_button, 'text', x))
        ...
        for option in self.probability_probe_list:
            ...
            probability_opt.bind(
                on_release=lambda probability_opt: self.probability_probe_dropdown.select(probability_opt.text))
        ...
        self.probability_probe_dropdown.bind(
            on_select=lambda instance, x: setattr(self.probability_probe_button, 'text', x))
